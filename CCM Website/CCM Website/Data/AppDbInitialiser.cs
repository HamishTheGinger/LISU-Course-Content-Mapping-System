            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.GraduateAttributes.Any())
                {
                    var graduateAttributes = new[]
                    {
                        ...
                        new GraduateAttribute
                        {
                            AttributeName = "Independent and Critical Thinkers",
                        },
                ...
                if (!context.LearningPlatformActivities.Any())
                {
                    ...
                    {
                        // Moodle
                        new LearningPlatformActivities
                        {
                        ...
                        {
                            LearningPlatform = moodle,
                            Activities = CodeGrade,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = CustomCertificate,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                        ...
                        {
                            LearningPlatform = moodle,
                            Activities = H5PInteractiveContent,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = HarvardBusinessPublishing,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = IMSContentPackage,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = KalturaMediaAssignment,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = KalturaVideoQuiz,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = KalturaVideoResource,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                        ...
                        {
                            LearningPlatform = moodle,
                            Activities = MATLABCodingProblem,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = OpenForum,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                        ...
                        {
                            LearningPlatform = moodle,
                            Activities = PearsonMyLabs,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = PeerAssessment,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                            Activities = PDFAnnotation,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                        ...
                        {
                            LearningPlatform = moodle,
                            Activities = ReadingListsGlasgow,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = moodle,
                        ...
                        {
                            LearningPlatform = coursera,
                            Activities = ProgrammingAssignment,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = coursera,
                        ...
                        {
                            LearningPlatform = coursera,
                            Activities = UngradedLab,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = coursera,
                            Activities = UngradedPlugin,
                        },
                        // FutureLearn
                        new LearningPlatformActivities
                        {
                            LearningPlatform = futureLearn,
                            Activities = Article,
                        },
                        new LearningPlatformActivities
                        {
                        ...
                        {
                            LearningPlatform = futureLearn,
                            Activities = ExerciseExternalTools,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = futureLearn,
                            Activities = PeerGradedAssignment,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = futureLearn,
                        ...
                        {
                            LearningPlatform = xSite,
                            Activities = HTMLDocument,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = xSite,
                            Activities = ManageFiles,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = xSite,
                            Activities = NewLesson,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = xSite,
                            Activities = MediaLibrary,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = xSite,
                        ...
                        {
                            LearningPlatform = COIL,
                            Activities = MicrosoftExcel,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = COIL,
                            Activities = MicrosoftOneNote,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = COIL,
                            Activities = MicrosoftPowerPoint,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = COIL,
                            Activities = MicrosoftSway,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = COIL,
                            Activities = MicrosoftTeams,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = COIL,
                            Activities = MicrosoftWord,
                        },
                        new LearningPlatformActivities
                        {
                            LearningPlatform = COIL,
